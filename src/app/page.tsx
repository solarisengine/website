      ...
      <section className="bg-gradient-to-r from-purple-800 to-fuchsia-900 py-20 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="mb-8 text-xl opacity-90">
            Empowering small to medium companies worldwide with intelligent solutions for lead generation,
            follow-up, and operational efficiency.
          </p>
          <a
            href="#contact"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            <div className="rounded-lg bg-gray-900 p-8 shadow-md">
              <h3 className="mb-4 text-2xl font-semibold text-purple-400">Manual Task Overload</h3>
              <p className="text-gray-300">Spending too much time on repetitive tasks instead of strategic growth?</p>
            </div>
            <div className="rounded-lg bg-gray-900 p-8 shadow-md">
              <h3 className="mb-4 text-2xl font-semibold text-purple-400">Inconsistent Lead Conversion</h3>
              <p className="text-gray-300">Struggling to effectively nurture leads and convert them into paying customers?</p>
            </div>
            <div className="rounded-lg bg-gray-900 p-8 shadow-md">
              <h3 className="mb-4 text-2xl font-semibold text-purple-400">Inefficient Workflows</h3>
              <p className="text-gray-300">Outdated processes hindering your team's productivity and overall efficiency?</p>
            </div>
          </div>
        </div>
      </AnimatedSection>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            <div className="rounded-lg bg-gray-900 p-8 shadow-md">
              ...
              <h3 className="mb-3 text-2xl font-semibold text-gray-100">AI-Powered Lead Generation</h3>
              <p className="text-gray-300">Identify, qualify, and attract high-quality leads with intelligent algorithms.</p>
            </div>
            <div className="rounded-lg bg-gray-900 p-8 shadow-md">
              <div className="mb-4 text-5xl text-purple-400">💬</div>
              <h3 className="mb-3 text-2xl font-semibold text-gray-100">Automated Follow-Up Systems</h3>
              <p className="text-gray-300">Ensure consistent and personalized communication with prospects and clients.</p>
            </div>
            <div className="rounded-lg bg-gray-900 p-8 shadow-md">
              <div className="mb-4 text-5xl text-purple-400">⚙️</div>
              <h3 className="mb-3 text-2xl font-semibold text-gray-100">Business Process Optimization</h3>
              <p className="text-gray-300">Streamline repetitive tasks and workflows to boost productivity and reduce costs.</p>
            </div>
          </div>
        </div>
      </AnimatedSection>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col items-center justify-center space-y-12 md:flex-row md:space-x-12 md:space-y-0">
            ...
            <div className="relative flex h-32 w-32 items-center justify-center rounded-full bg-purple-900 text-purple-200 md:h-40 md:w-40">
              <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-5xl font-bold text-purple-500">1</span>
              <p className="text-center text-xl font-semibold">Discovery & Strategy</p>
            </div>
            {/* Step 2 */}
            <div className="relative flex h-32 w-32 items-center justify-center rounded-full bg-fuchsia-900 text-fuchsia-200 md:h-40 md:w-40">
              <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-5xl font-bold text-fuchsia-500">2</span>
              <p className="text-center text-xl font-semibold">Solution Build & Integrate</p>
            </div>
            {/* Step 3 */}
            <div className="relative flex h-32 w-32 items-center justify-center rounded-full bg-indigo-900 text-indigo-200 md:h-40 md:w-40">
              <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-5xl font-bold text-indigo-500">3</span>
              <p className="text-center text-xl font-semibold">Launch & Optimize</p>
            </div>
          </div>
        </div>
      </AnimatedSection>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <ul className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <li className="flex items-center justify-center space-x-3 text-xl">
              <svg className="h-7 w-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
      ...
      <AnimatedSection id="testimonials" className="py-16 text-center bg-gray-950">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto italic text-gray-300">
            <p className="mb-4">
              "Solaris Engine transformed our lead generation process. We're seeing a significant increase in qualified leads and our team is more efficient than ever!"
            </p>
      ...
      <AnimatedSection id="contact" className="bg-gray-900 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-10 text-xl text-gray-300">
            Get a free consultation to see how AI-driven automation can work for you.
          </p>
          <a
